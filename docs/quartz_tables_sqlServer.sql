...
IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_J')--检测是否已经存在IX_TEST_TNAME索引
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_J--如果存在则删除

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_JG')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_JG

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_C')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_C

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_G')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_G

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_G_J')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_G_J

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_STATE')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_STATE

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_N_STATE')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_N_STATE

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_N_G_STATE')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_N_G_STATE

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_NEXT_FIRE_TIME')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_NEXT_FIRE_TIME

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_NFT_ST')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_NFT_ST

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_NFT_MISFIRE')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_NFT_MISFIRE

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_NFT_ST_MISFIRE')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_NFT_ST_MISFIRE

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_T_NFT_ST_MISFIRE_GRP')
DROP INDEX [dbo].[QRTZ_TRIGGERS].IDX_QRTZ_T_NFT_ST_MISFIRE_GRP

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_FT_TRIG_INST_NAME')
DROP INDEX [dbo].[QRTZ_FIRED_TRIGGERS].IDX_QRTZ_FT_TRIG_INST_NAME

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_FT_INST_JOB_REQ_RCVRY')
DROP INDEX [dbo].[QRTZ_FIRED_TRIGGERS].IDX_QRTZ_FT_INST_JOB_REQ_RCVRY

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_FT_J_G')
DROP INDEX [dbo].[QRTZ_FIRED_TRIGGERS].IDX_QRTZ_FT_J_G

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_FT_JG')
DROP INDEX [dbo].[QRTZ_FIRED_TRIGGERS].IDX_QRTZ_FT_JG

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_FT_T_G')
DROP INDEX [dbo].[QRTZ_FIRED_TRIGGERS].IDX_QRTZ_FT_T_G

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_FT_TG')
DROP INDEX [dbo].[QRTZ_FIRED_TRIGGERS].IDX_QRTZ_FT_TG

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_FT_G_J')
DROP INDEX [dbo].[QRTZ_FIRED_TRIGGERS].IDX_QRTZ_FT_G_J

IF EXISTS (SELECT 1 FROM SYSINDEXES WHERE NAME='IDX_QRTZ_FT_G_T')
DROP INDEX [dbo].[QRTZ_FIRED_TRIGGERS].IDX_QRTZ_FT_G_T
